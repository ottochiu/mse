 ...
 * Original file: C:\\Users\\chiuo01\\workspace\\mse\\BluetoothDeviceManager\\src\\com\\ottochiu\\mse\\bluetooth_device_manager\\IBluetoothReadCallback.aidl
 */
...
int _arg0;
_arg0 = data.readInt();
java.util.List<byte> _arg1;
_arg1 = data.createBinderArrayList();
this.handle(_arg0, _arg1);
return true;
}
}
...
public void handle(int id, java.util.List<byte> data) throws android.os.RemoteException
{
